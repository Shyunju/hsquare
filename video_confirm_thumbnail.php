...
<body>
    ...
    <div id='left_side'>
        <input type="button" name="confirm_button" value="컨펌" onClick="location.href='video_confirm_thumbnail.php'"><br>
        <input type="button" name="finish_button" value="완료" onClick="location.href='video_finish_thumbnail.php'">
    </div>
    <div id='content'>
        <span id='title'>
        <?php
